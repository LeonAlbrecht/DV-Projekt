...
public class PvPModeSelector implements ActionListener{
	
	JFrame frame = new JFrame();
	JLabel label = new JLabel("Select Mode For PvP");
	...
	if(e.getSource()==sbutton) {
		...
		frame.dispose();
		SpecialPvP spvp = new SpecialPvP();
